...
* Open a shell (git bash on Windows) in the folder where you want to install it
...
* From the shell run:\
  ...
  Note: Windows/WSL. The WSL installer will remove uppercase characters.\
  Note: Windows/WSL. Please re-type your Windows user all lowercase when prompted by the WSL installer.
